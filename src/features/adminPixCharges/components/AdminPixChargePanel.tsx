  ...
  return (
    <section className="rounded-xl border border-blue-200 bg-blue-50/50 p-4">
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-2">
        ...
        {!terminal && payment && <button type="button" disabled={busy !== ""} onClick={() => void run("cancel")} className="flex items-center justify-center gap-2 rounded-lg border border-red-200 bg-white px-3 py-2 text-sm font-semibold text-red-700 disabled:opacity-50"><XCircle className="h-4 w-4" /> Cancelar cobrança</button>}
      </div>
