...
export function SalaoPage() {
  ...
  const printSalaoComanda = (comanda: any) => {
    ...
    printWindow.document.write(`<!DOCTYPE html>
      ...
      <style>
        *{margin:0;padding:0;box-sizing:border-box}html,body{width:80mm;min-height:30mm}body{font-family:'Courier New',Courier,monospace;width:80mm;min-height:30mm;max-width:80mm;margin:0 auto;padding:3mm;font-size:30px;font-weight:700;color:#000;-webkit-print-color-adjust:exact;print-color-adjust:exact}body *{color:#000!important;font-weight:700}.center{text-align:center}.bold{font-weight:800}.large{font-size:34px}.divider-solid{border-top:2px solid #000;margin:12px 0}.divider{border-top:2px dashed #000;margin:12px 0}.row{display:flex;justify-content:space-between;gap:8px;margin-bottom:3px}.row-total{display:flex;justify-content:space-between;gap:8px;font-size:34px;font-weight:800;margin-bottom:5px}.person{padding:8px 0}.person-title{font-weight:800;margin-bottom:6px}.subtotal{margin-top:6px;font-weight:800}.option{font-size:26px;margin:0 0 4px 18px}.obs{font-size:26px;margin:0 0 8px 18px;font-style:italic}.tag{display:inline-block;border:2px solid #000;padding:2px 8px;font-size:28px;margin:4px 0}p{margin-bottom:7px}@page{size:80mm 200mm;margin:0}@media print{html,body{width:80mm;min-height:30mm}body{margin:0;padding:3mm}}
      </style></head><body>
        <div class="center">
