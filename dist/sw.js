 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */li();const D={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},lt="admin-delivery-push-v1",gi="ali-compras-admin-images:",mi=[{"revision":"89612c94f8a79ec953c26666000acd32","url":"offline.html"},{"revision":"b97918c4c9aeaf118cf44532bd3669ab","url":"manifest.webmanifest"},{"revision":"ebab3545e2d7d11b2622d0831f1a96dd","url":"index.html"},{"revision":"c8d0485de5f1bb9c7e89ed7a75379c83","url":"icons/pwa-maskable-512x512.png"},{"revision":"caf9b009f7d30d186c25f98608d2e4cc","url":"icons/pwa-maskable-192x192.png"},{"revision":"5ae11825f007bfbb756867e7a876cfe4","url":"icons/pwa-logo-96x96.png"},{"revision":"95e4b761dc351ae0aee37076d680ce8e","url":"icons/pwa-logo-72x72.png"},{"revision":"19defb9945a499844f7d5669ebb19e9f","url":"icons/pwa-logo-512x512.png"},{"revision":"53cb73c6a26690072b8b961224c7dcc0","url":"icons/pwa-logo-384x384.png"},{"revision":"b4d3e8182f8bb572e3c5ee29118b4631","url":"icons/pwa-logo-192x192.png"},{"revision":"8300c19a0b72bdfb09e8bdc486c80de1","url":"icons/pwa-logo-180x180.png"},{"revision":"29c3306488b29bbbd4556a4a4e9a8c2a","url":"icons/pwa-logo-152x152.png"},{"revision":"2cb17afa7c6a93677e1265a875b74ca2","url":"icons/pwa-logo-144x144.png"},{"revision":"e68ee887e685356d09f1a12ca1cbd0d0","url":"icons/pwa-logo-128x128.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/maskable-512x512.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/maskable-192x192.png"},{"revision":"721025be42e0691c1c2992580ce6d552","url":"icons/image.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-96x96.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-72x72.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-512x512.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-384x384.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-192x192.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-180x180.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-152x152.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-144x144.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-128x128.png"},{"revision":"692b759aa860e0ed63731df46f424152","url":"icons/LOGO real (192).svg"},{"revision":null,"url":"assets/notificationsService-B0eR9Xim.js"},{"revision":null,"url":"assets/nome-entregai-CRazNOq-.svg"},{"revision":null,"url":"assets/logo-entregai-DI-5NNs7.svg"},{"revision":null,"url":"assets/logo-IAw9vYqZ.png"},{"revision":null,"url":"assets/index-L5Rd24ds.css"},{"revision":null,"url":"assets/index-BmYTDrPJ.js"},{"revision":null,"url":"assets/NotificationsPage-BQ4KBZFc.js"}].map(e=>e.url);self.addEventListener("install",e=>{e.waitUntil(caches.open(lt).then(t=>t.addAll(mi)).then(()=>self.skipWaiting()))});self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(t=>Promise.all(t.filter(n=>n!==lt&&!n.startsWith(gi)).map(n=>caches.delete(n)))).then(()=>self.clients.claim()))});self.addEventListener("fetch",e=>{if(e.request.method==="GET"){if(e.request.destination==="image"){e.respondWith(caches.match(e.request).then(t=>t||fetch(e.request)));return}new URL(e.request.url).origin===self.location.origin&&e.respondWith(fetch(e.request).catch(()=>caches.match(e.request).then(t=>t||caches.match("/index.html"))))}});if(D.apiKey&&D.projectId&&D.messagingSenderId&&D.appId){const e=hi(Fe(D));pi(e,t=>{const n=t.data||{},r=n.title||"Nova notificação";self.registration.showNotification(r,{body:n.body,image:n.image_url||void 0,icon:"/icons/icon-192x192.png",data:n})})}self.addEventListener("notificationclick",e=>{var r;e.notification.close();const t=String(((r=e.notification.data)==null?void 0:r.route)||"/notifications"),n=new URL(t,self.location.origin).href;e.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(async i=>{const o=i[0];return o?(await o.navigate(n),o.focus()):self.clients.openWindow(n)}))});
