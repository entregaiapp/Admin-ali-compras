 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */li();const D={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},lt="admin-delivery-push-v1",gi="ali-compras-admin-images:",mi=[{"revision":"89612c94f8a79ec953c26666000acd32","url":"offline.html"},{"revision":"13e5d51f13b51f1e49343077f04bcc3f","url":"manifest.webmanifest"},{"revision":"b01b1d791bae44bf726791f898690a06","url":"index.html"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/maskable-512x512.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/maskable-192x192.png"},{"revision":"721025be42e0691c1c2992580ce6d552","url":"icons/image.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-96x96.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-72x72.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-512x512.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-384x384.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-192x192.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-180x180.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-152x152.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-144x144.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-128x128.png"},{"revision":null,"url":"assets/notificationsService-PV-0gyyU.js"},{"revision":null,"url":"assets/nome-entregai-CRazNOq-.svg"},{"revision":null,"url":"assets/logo-entregai-DI-5NNs7.svg"},{"revision":null,"url":"assets/index-JEJSEOe-.css"},{"revision":null,"url":"assets/index-5zTKwNb4.js"},{"revision":null,"url":"assets/NotificationsPage-r8aqVxCg.js"}].map(e=>e.url);self.addEventListener("install",e=>{e.waitUntil(caches.open(lt).then(t=>t.addAll(mi)).then(()=>self.skipWaiting()))});self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(t=>Promise.all(t.filter(n=>n!==lt&&!n.startsWith(gi)).map(n=>caches.delete(n)))).then(()=>self.clients.claim()))});self.addEventListener("fetch",e=>{if(e.request.method==="GET"){if(e.request.destination==="image"){e.respondWith(caches.match(e.request).then(t=>t||fetch(e.request)));return}new URL(e.request.url).origin===self.location.origin&&e.respondWith(fetch(e.request).catch(()=>caches.match(e.request).then(t=>t||caches.match("/index.html"))))}});if(D.apiKey&&D.projectId&&D.messagingSenderId&&D.appId){const e=hi(Fe(D));pi(e,t=>{const n=t.data||{},r=n.title||"Nova notificação";self.registration.showNotification(r,{body:n.body,image:n.image_url||void 0,icon:"/icons/icon-192x192.png",data:n})})}self.addEventListener("notificationclick",e=>{var r;e.notification.close();const t=String(((r=e.notification.data)==null?void 0:r.route)||"/notifications"),n=new URL(t,self.location.origin).href;e.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(async i=>{const o=i[0];return o?(await o.navigate(n),o.focus()):self.clients.openWindow(n)}))});
