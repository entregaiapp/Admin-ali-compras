 ...
 */const ve=function(e){const t=[];let n=0;for(let r=0;r<e.length;r++){let i=e.charCodeAt(r);i<128?t[n++]=i:i<2048?(t[n++]=i>>6|192,t[n++]=i&63|128):(i&64512)===55296&&r+1<e.length&&(e.charCodeAt(r+1)&64512)===56320?(i=65536+((i&1023)<<10)+(e.charCodeAt(++r)&1023),t[n++]=i>>18|240,t[n++]=i>>12&63|128,t[n++]=i>>6&63|128,t[n++]=i&63|128):(t[n++]=i>>12|224,t[n++]=i>>6&63|128,t[n++]=i&63|128)}return t},ht=function(e){const t=[];let n=0,r=0;for(;n<e.length;){const i=e[n++];if(i<128)t[r++]=String.fromCharCode(i);else if(i>191&&i<224){const o=e[n++];t[r++]=String.fromCharCode((i&31)<<6|o&63)}else if(i>239&&i<365){const o=e[n++],s=e[n++],c=e[n++],u=((i&7)<<18|(o&63)<<12|(s&63)<<6|c&63)-65536;t[r++]=String.fromCharCode(55296+(u>>10)),t[r++]=String.fromCharCode(56320+(u&1023))}else{const o=e[n++],s=e[n++];t[r++]=String.fromCharCode((i&15)<<12|(o&63)<<6|s&63)}}return t.join("")},Oe={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(e,t){if(!Array.isArray(e))throw Error("encodeByteArray takes an array as a parameter");this.init_();const n=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let i=0;i<e.length;i+=3){const o=e[i],s=i+1<e.length,c=s?e[i+1]:0,u=i+2<e.length,a=u?e[i+2]:0,k=o>>2,T=(o&3)<<4|c>>4;let v=(c&15)<<2|a>>6,O=a&63;u||(O=64,s||(v=64)),r.push(n[k],n[T],n[v],n[O])}return r.join("")},encodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(e):this.encodeByteArray(ve(e),t)},decodeString(e,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(e):ht(this.decodeStringToByteArray(e,t))},decodeStringToByteArray(e,t){this.init_();const n=t?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let i=0;i<e.length;){const o=n[e.charAt(i++)],c=i<e.length?n[e.charAt(i)]:0;++i;const a=i<e.length?n[e.charAt(i)]:64;++i;const T=i<e.length?n[e.charAt(i)]:64;if(++i,o==null||c==null||a==null||T==null)throw new pt;const v=o<<2|c>>4;if(r.push(v),a!==64){const O=c<<4&240|a>>2;if(r.push(O),T!==64){const dt=a<<6&192|T;r.push(dt)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let e=0;e<this.ENCODED_VALS.length;e++)this.byteToCharMap_[e]=this.ENCODED_VALS.charAt(e),this.charToByteMap_[this.byteToCharMap_[e]]=e,this.byteToCharMapWebSafe_[e]=this.ENCODED_VALS_WEBSAFE.charAt(e),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[e]]=e,e>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(e)]=e,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(e)]=e)}}};class pt extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const gt=function(e){const t=ve(e);return Oe.encodeByteArray(t,!0)},Me=function(e){return gt(e).replace(/\./g,"")},mt=function(e){try{return Oe.decodeString(e,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vt{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const n=this.getProvider(t.name);if(n.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);n.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const n=new Dt(t,this);return this.providers.set(t,n),n}getProviders(){return Array.from(this.providers.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Or="firebase-messaging-database",Mr=1,E="firebase-messaging-store";let z=null;function ce(){return z||(z=P(Or,Mr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(E)}}})),z}async function ue(e){const t=de(e),r=await(await ce()).transaction(E).objectStore(E).get(t);if(r)return r;{const i=await kr(e.appConfig.senderId);if(i)return await le(e,i),i}}async function le(e,t){const n=de(e),i=(await ce()).transaction(E,"readwrite");return await i.objectStore(E).put(t,n),await i.done,t}async function Nr(e){const t=de(e),r=(await ce()).transaction(E,"readwrite");await r.objectStore(E).delete(t),await r.done}function de({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pr=10080*60*1e3;async function Lr(e){const t=await xr(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:f(t.getKey("auth")),p256dh:f(t.getKey("p256dh"))},r=await ue(e.firebaseDependencies);if(r){if(Hr(r.subscriptionOptions,n))return Date.now()>=r.createTime+Pr?Fr(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await at(e.firebaseDependencies,r.token)}catch(i){console.warn(i)}return ke(e.firebaseDependencies,n)}else return ke(e.firebaseDependencies,n)}async function Ce(e){const t=await ue(e.firebaseDependencies);t&&(await at(e.firebaseDependencies,t.token),await Nr(e.firebaseDependencies));const n=await e.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function Fr(e,t){try{const n=await $r(e.firebaseDependencies,t),r={...t,token:n,createTime:Date.now()};return await le(e.firebaseDependencies,r),n}catch(n){throw n}}async function ke(e,t){const r={token:await Rr(e,t),createTime:Date.now(),subscriptionOptions:t};return await le(e,r),r.token}async function xr(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Dr(t)})}function Hr(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,i=t.auth===e.auth,o=t.p256dh===e.p256dh;return n&&r&&i&&o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */li();const D={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},lt="admin-delivery-push-v1",gi="ali-compras-admin-images:",mi=[{"revision":"fcf46e8a2e8af5ac2afe77a97e7bea4a","url":"offline.html"},{"revision":"2079ba4632ab6631b2c5febdd5372dba","url":"manifest.webmanifest"},{"revision":"19f468f734d0e22d6ec22e56e4536e20","url":"index.html"},{"revision":"c8d0485de5f1bb9c7e89ed7a75379c83","url":"icons/pwa-maskable-512x512.png"},{"revision":"caf9b009f7d30d186c25f98608d2e4cc","url":"icons/pwa-maskable-192x192.png"},{"revision":"5ae11825f007bfbb756867e7a876cfe4","url":"icons/pwa-logo-96x96.png"},{"revision":"95e4b761dc351ae0aee37076d680ce8e","url":"icons/pwa-logo-72x72.png"},{"revision":"19defb9945a499844f7d5669ebb19e9f","url":"icons/pwa-logo-512x512.png"},{"revision":"53cb73c6a26690072b8b961224c7dcc0","url":"icons/pwa-logo-384x384.png"},{"revision":"b4d3e8182f8bb572e3c5ee29118b4631","url":"icons/pwa-logo-192x192.png"},{"revision":"8300c19a0b72bdfb09e8bdc486c80de1","url":"icons/pwa-logo-180x180.png"},{"revision":"29c3306488b29bbbd4556a4a4e9a8c2a","url":"icons/pwa-logo-152x152.png"},{"revision":"2cb17afa7c6a93677e1265a875b74ca2","url":"icons/pwa-logo-144x144.png"},{"revision":"e68ee887e685356d09f1a12ca1cbd0d0","url":"icons/pwa-logo-128x128.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/maskable-512x512.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/maskable-192x192.png"},{"revision":"692b759aa860e0ed63731df46f424152","url":"icons/LOGO real (192).svg"},{"revision":"721025be42e0691c1c2992580ce6d552","url":"icons/image.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-96x96.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-72x72.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-512x512.png"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-384x384.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-192x192.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-180x180.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-152x152.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-144x144.png"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-128x128.png"},{"revision":null,"url":"assets/notificationsService-19YszF4q.js"},{"revision":null,"url":"assets/NotificationsPage-CQ9cegPa.js"},{"revision":null,"url":"assets/nome-entregai-CRazNOq-.svg"},{"revision":null,"url":"assets/logo-IAw9vYqZ.png"},{"revision":null,"url":"assets/logo-entregai-DI-5NNs7.svg"},{"revision":null,"url":"assets/index-DpX6mRZO.js"},{"revision":null,"url":"assets/index-Cwu96NtS.css"}].map(e=>e.url);self.addEventListener("install",e=>{e.waitUntil(caches.open(lt).then(t=>t.addAll(mi)).then(()=>self.skipWaiting()))});self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(t=>Promise.all(t.filter(n=>n!==lt&&!n.startsWith(gi)).map(n=>caches.delete(n)))).then(()=>self.clients.claim()))});self.addEventListener("fetch",e=>{if(e.request.method==="GET"){if(e.request.destination==="image"){e.respondWith(caches.match(e.request).then(t=>t||fetch(e.request)));return}new URL(e.request.url).origin===self.location.origin&&e.respondWith(fetch(e.request).catch(()=>caches.match(e.request).then(t=>t||caches.match("/index.html"))))}});if(D.apiKey&&D.projectId&&D.messagingSenderId&&D.appId){const e=hi(Fe(D));pi(e,t=>{const n=t.data||{},r=n.title||"Nova notificação";self.registration.showNotification(r,{body:n.body,image:n.image_url||void 0,icon:"/icons/icon-192x192.png",data:n})})}self.addEventListener("notificationclick",e=>{var r;e.notification.close();const t=String(((r=e.notification.data)==null?void 0:r.route)||"/notifications"),n=new URL(t,self.location.origin).href;e.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(async i=>{const o=i[0];return o?(await o.navigate(n),o.focus()):self.clients.openWindow(n)}))});
