import{a as S}from"./index-DnBTv0R6.js";const pt=()=>{};var fe={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vt="FirebaseError";class A extends Error{constructor(t,n,r){super(n),this.code=t,this.customData=r,this.name=vt,Object.setPrototypeOf(this,A.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,P.prototype.create)}}class P{constructor(t,n,r){this.service=t,this.serviceName=n,this.errors=r}create(t,...n){const r=n[0]||{},a=`${this.service}/${t}`,i=this.errors[t],o=i?Dt(i,r):"Error",c=`${this.serviceName}: ${o} (${a}).`;return new A(a,c,r)}}function Dt(e,t){return e.replace(Ct,(n,r)=>{const a=t[r];return a!=null?String(a):`<${r}?>`})}const Ct=/\{\$([^}]+)}/g;function J(e,t){if(e===t)return!0;const n=Object.keys(e),r=Object.keys(t);for(const a of n){if(!r.includes(a))return!1;const i=e[a],o=t[a];if(le(i)&&le(o)){if(!J(i,o))return!1}else if(i!==o)return!1}for(const a of r)if(!n.includes(a))return!1;return!0}function le(e){return e!==null&&typeof e=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vn{constructor(t,n,r){this._isDeleted=!1,this._options={...t},this._config={...n},this._name=n.name,this._automaticDataCollectionEnabled=n.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new b("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw g.create("app-deleted",{appName:this._name})}}function xe(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r={name:Q,automaticDataCollectionEnabled:!0,...t},a=r.name;if(typeof a!="string"||!a)throw g.create("bad-app-name",{appName:String(a)});if(n||(n=Re()),!n)throw g.create("no-options");const i=D.get(a);if(i){if(J(n,i.options)&&J(r,i.config))return i;throw g.create("duplicate-app",{appName:a})}const o=new Mt(a);for(const u of ee.values())o.addComponent(u);const c=new vn(n,r,o);return D.set(a,c),c}function Dn(e=Q){const t=D.get(e);if(!t&&e===Q&&Re())return xe();if(!t)throw g.create("no-app",{appName:e});return t}function Cn(){return Array.from(D.values())}function m(e,t,n){let r=Sn[e]??e;n&&(r+=`-${n}`);const a=r.match(/\s|\//),i=t.match(/\s|\//);if(a||i){const o=[`Unable to register library "${r}" with version "${t}":`];a&&o.push(`library name "${r}" contains illegal characters (whitespace or "/")`),a&&i&&o.push("and"),i&&o.push(`version name "${t}" contains illegal characters (whitespace or "/")`),p.warn(o.join(" "));return}I(new b(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kn="firebase-heartbeat-database",On=1,C="firebase-heartbeat-store";let K=null;function Ve(){return K||(K=$(kn,On,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(C)}catch(n){console.warn(n)}}}}).catch(e=>{throw g.create("idb-open",{originalErrorMessage:e.message})})),K}async function Nn(e){try{const n=(await Ve()).transaction(C),r=await n.objectStore(C).get(je(e));return await n.done,r}catch(t){if(t instanceof A)p.warn(t.message);else{const n=g.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});p.warn(n.message)}}}async function we(e,t){try{const r=(await Ve()).transaction(C,"readwrite");await r.objectStore(C).put(t,je(e)),await r.done}catch(n){if(n instanceof A)p.warn(n.message);else{const r=g.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});p.warn(r.message)}}}function je(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $r="firebase-messaging-database",Fr=1,O="firebase-messaging-store";let z=null;function ut(){return z||(z=$($r,Fr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(O)}}})),z}async function Lr(e){const t=dt(e),r=await(await ut()).transaction(O).objectStore(O).get(t);if(r)return r;{const a=await Rr(e.appConfig.senderId);if(a)return await ce(e,a),a}}async function ce(e,t){const n=dt(e),a=(await ut()).transaction(O,"readwrite");return await a.objectStore(O).put(t,n),await a.done,t}function dt({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ia(e,t,n){const r=oa(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[ct],message_name:n[kr],message_time:n[Or],message_device_time:Math.floor(Date.now()/1e3)})}function oa(e){switch(e){case k.NOTIFICATION_CLICKED:return"notification_open";case k.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function sa(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===k.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(De(n)):e.onMessageHandler.next(De(n)));const r=n.data;Xr(r)&&r[Nr]==="1"&&await ia(e,n.messageType,r)}const Ce="@firebase/messaging",ke="0.12.26";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function la(e=Dn()){return lt().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),re(Fe(e),"messaging").getImmediate()}function ha(e,t){return e=Fe(e),fa(e,t)}da();const v={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},Oe="admin_notification_fcm_token",pa=()=>!!(v.apiKey&&v.projectId&&v.messagingSenderId&&v.appId);async function ga(){if(!pa()||!await lt())return null;const e=Cn()[0]||xe(v);return la(e)}async function ba(){throw!("Notification"in window)||!("serviceWorker"in navigator)?new Error("Este navegador não suporta notificações push."):new Error("A chave VITE_FIREBASE_VAPID_KEY não foi incluída no build do painel admin.")}async function wa(){const e=localStorage.getItem(Oe);if(e)try{await S.post("/notifications/deactivate-device",{fcm_token:e})}finally{localStorage.removeItem(Oe)}}async function ya(e){const t=await ga();return t?ha(t,n=>{window.dispatchEvent(new CustomEvent("notification-received",{detail:n.data})),e(n)}):()=>{}}async function Ia(){return(await S.get("/notifications")).data.data||[]}async function Ea(e){return(await S.patch(`/notifications/${e}/read`)).data.data}async function _a(){return(await S.patch("/notifications/read")).data.data||[]}async function Sa(){return(await S.get("/tenant/notifications/campaigns")).data.data||[]}async function Aa(e){return(await S.post("/tenant/notifications/campaigns",e)).data.data}export{Aa as createCampaign,wa as disableAdminPush,ba as enableAdminPush,Sa as fetchCampaigns,Ia as fetchNotifications,ya as listenForAdminPush,_a as readAllNotifications,Ea as readNotification};
